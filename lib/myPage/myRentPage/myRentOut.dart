...
import 'myRentOutService.dart';
import 'RentOutDetail.dart';
import 'package:renty_client/chat/chat.dart';

class MyRentOutPage extends StatefulWidget {
  const MyRentOutPage({super.key});

  @override
  State<MyRentOutPage> createState() => _MyRentOutPageState();
}

class _MyRentOutPageState extends State<MyRentOutPage> {
  ...
  Future<void> fetchRentOutItems() async {
    ...
    final items = await RentOutService.fetchRentOutItems();
    setState(() {
      _items = items;
      _isLoading = false;
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("빌려준 내역")),
      body: _isLoading
